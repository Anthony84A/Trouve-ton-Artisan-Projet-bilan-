...
export class ArtisanService {
  ...
  private artisans: ArtisanModel[] = [
    ...
    },
    {
      ...
      about: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eleifend ante sem, id volutpat massa fermentum nec. Praesent volutpat scelerisque mauris, quis sollicitudin tellus sollicitudin.",
      email: "ernest.carignan@gmail.com",
      website: "https://ferronnerie-carignan.com",
      category: "Bâtiment",
      top: false
    },
    {
  ...
  getArtisans(): ArtisanModel[] {
    return this.artisans;
  }

  getArtisansByCategory(category: string): Observable<ArtisanModel[]> {
    const artisansByCategory = this.artisans.filter(artisan => artisan.category === category);
    return of(artisansByCategory); 
  }

  // Méthode pour obtenir un artisan par ID
  getArtisanById(artisanId: string): ArtisanModel | undefined {
    return this.artisans.find(artisan => artisan.id === artisanId);
  }

  searchArtisans(query: string): Observable<ArtisanModel[]> {
